...
export const translationKeys = [
  ...
  'home.page.title',
  'home.page.actions.moreInfo',
  'home.page.actions.more',
  'home.page.empty.noProfile',
  'home.page.empty.addProfile',
  'home.page.empty.enableCardsHint',
  'home.components.proxyTun.fields.systemProxy',
  'home.components.proxyTun.fields.tunMode',
  'home.components.proxyTun.badges.recommended',
  'home.components.proxyTun.badges.advanced',
  'home.components.proxyTun.actions.showAdvanced',
  'home.components.proxyTun.actions.hideAdvanced',
  'home.components.proxyTun.status.inactive',
  'home.components.proxyTun.status.systemProxy',
  'home.components.proxyTun.status.tun',
  'home.components.proxyTun.status.both',
  'home.components.proxyTun.tooltips.systemProxy',
  'home.components.proxyTun.tooltips.tunMode',
  'home.components.proxyTun.tooltips.tunNeedsSetup',
  ...
  'layout.components.titlebar.newVersion',
  'layout.components.titlebar.newVersionTooltip',
  ...
  'profiles.components.menu.copySubscription',
  ...
  'proxies.page.focus.title',
  'proxies.page.focus.allTitle',
  'proxies.page.focus.viewMode',
  'proxies.page.focus.modes.focus',
  'proxies.page.focus.modes.all',
  'proxies.page.focus.current',
  'proxies.page.focus.primary',
  'proxies.page.focus.groupCount',
  'proxies.page.focus.hint',
  ...
  'proxies.page.tooltips.moreTools',
  ...
  'proxies.page.autoSwitch.empty',
  'proxies.page.autoSwitch.hintTitle',
  'proxies.page.autoSwitch.hintBody',
  'proxies.page.autoSwitch.defaultName',
  'proxies.page.autoSwitch.listMeta',
  'proxies.page.autoSwitch.testNow',
  'proxies.page.autoSwitch.saved',
  'proxies.page.autoSwitch.switched',
  'proxies.page.autoSwitch.testedKeep',
  'proxies.page.autoSwitch.intervalSeconds',
  'proxies.page.autoSwitch.intervalMinutes',
  'proxies.page.autoSwitch.thresholdMs',
  'proxies.page.autoSwitch.thresholdAlways',
  'proxies.page.autoSwitch.clearNodes',
  'proxies.page.autoSwitch.searchNodes',
  'proxies.page.autoSwitch.pickTargetFirst',
  'proxies.page.autoSwitch.noMatchingNodes',
  'proxies.page.autoSwitch.fields.name',
  'proxies.page.autoSwitch.fields.targetGroup',
  'proxies.page.autoSwitch.fields.enabled',
  'proxies.page.autoSwitch.fields.interval',
  'proxies.page.autoSwitch.fields.intervalHint',
  'proxies.page.autoSwitch.fields.intervalCustom',
  'proxies.page.autoSwitch.fields.threshold',
  'proxies.page.autoSwitch.fields.thresholdHint',
  'proxies.page.autoSwitch.fields.thresholdCustom',
  'proxies.page.autoSwitch.fields.nodes',
  'proxies.page.autoSwitch.errors.nameRequired',
  'proxies.page.autoSwitch.errors.targetRequired',
  'proxies.page.autoSwitch.errors.minNodes',
  ...
  'rules.page.title',
  'rules.page.actions.editGlobal',
  'rules.page.actions.addGlobal',
  'rules.page.filters.allTypes',
  'rules.page.filters.allPolicies',
  'rules.page.filters.global',
  'rules.page.filters.allRules',
  'rules.page.filters.subscription',
  'rules.page.stats.total',
  'rules.page.stats.providers',
  'rules.page.stats.showing',
  'rules.page.empty.filtered',
  'rules.page.empty.global',
  ...
  'rules.modals.add.title',
  'rules.modals.add.position',
  'rules.modals.add.submit',
  'rules.modals.add.feedback.duplicate',
  'rules.modals.add.feedback.failed',
  ...
  'rules.modals.editor.globalHint',
  'rules.modals.editor.presets.title',
  'rules.modals.editor.presets.lanDirect',
  'rules.modals.editor.presets.lanAdded',
  'rules.modals.editor.presets.domainPlaceholder',
  'rules.modals.editor.presets.addDomainDirect',
  'settings.page.actions.manual',
  'settings.page.actions.telegram',
  'settings.page.actions.github',
  'settings.page.actionsGroupLabel',
  'settings.page.title',
  'settings.page.sections.appearance',
  'settings.page.sections.behavior',
  'settings.page.sections.advanced',
  ...
  'settings.modals.update.messages.unavailable',
  ...
  'traffic.loading',
  'traffic.empty',
  'traffic.searchPlaceholder',
  'traffic.ranges.day',
  'traffic.ranges.week',
  'traffic.ranges.month',
  'traffic.ranges.year',
  'traffic.summary.total',
  'traffic.summary.proxy',
  'traffic.summary.direct',
  'traffic.columns.domain',
  'traffic.columns.proxy',
  'traffic.columns.direct',
  'traffic.columns.total',
  'traffic.actions.refresh',
  'traffic.actions.cleanup',
  'traffic.actions.cleanupTitle',
  'traffic.actions.cleanupDesc',
  'traffic.actions.clear',
  'traffic.actions.clearAllHint',
  'traffic.actions.clearConfirm',
  'traffic.actions.clearDone',
  'traffic.actions.clearBeforeLabel',
  'traffic.actions.clearBefore',
  'traffic.actions.clearBeforeHint',
  'traffic.actions.clearBeforeConfirm',
  'traffic.actions.clearBeforeEmpty',
  'traffic.actions.clearBeforeDone',
] as const
